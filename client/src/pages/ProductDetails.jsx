    ...
    return product && (
        <div className="mt-12">
            ...
            <div className='flex flex-col items-center mt-20'>
               ...
               <div className='grid grid-cols-2 sm:grid-cols- md:grid-cols-3 gap-3 md:gap-6 lg:grid-cols-4 mt-6 w-full'>
                {relatedProducts.filter((products)=>product.inStock).map((product,index)=>(
